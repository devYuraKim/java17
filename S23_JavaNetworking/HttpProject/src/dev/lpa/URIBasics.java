...
public class URIBasics {
    ...
    public static void main(String[] args) {
        ...
        //URI yuraSite = URI.create("https://yurakim.webpage/courses/java");
        URI baseSite = URI.create("https://yurakim.webpage");
        URI yuraSite = URI.create("courses/java");
        print(yuraSite);
        ...
        try {
            ...
            //URL url = uri.toURL();
            URI masterClass = baseSite.resolve(yuraSite);
    ...
    private static void print(URI uri){
        System.out.printf("""
                ...
                uri.getAuthority(), uri.getUserInfo(), uri.getHost(), uri.getPort(),uri.getPath(), uri.getQuery(),
                uri.getFragment()
                );
    }
